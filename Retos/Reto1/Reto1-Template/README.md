...
2. [Data](./Data) Folder with CSV data files to load into the application. In here the students add the data files provided by the course staff to complete the challenge.
3. [Docs](./Docs) Folder with the reports, data table and other documentation. In here the students add their project report, data tables and other documentation to complement their code implementation.
