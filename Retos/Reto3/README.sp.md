...
El tercer proyecto se centra en el uso de los ADT Mapas Ordenados, principalmente el árbol de búsqueda binaria (BST) y el árbol rojo-negro (RBT). También integra el uso de todos los ADT anteriores (ej.: Lista, Pila, Cola y Mapa).
