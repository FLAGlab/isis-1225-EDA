...
def printBooksbyTag(books):
    ...
    """
    if (books):
        print('Se encontraron: ' + str(size(books)) + ' Libros.')
        #TODO - iterate over the books and print the title of each boo
...
def printBooksbyYear(books):
    ...
    if(books):
        print('Se encontraron: ' + str(size(books)) + ' Libros')
        #TODO iterate over the books and print their title
...
def printBestBooks(books):
    ...
    if size:
        ...
        #iterate over the books and print
        #'Titulo: ' + book['title'] + '  ISBN: ' + book['isbn'] + ' Rating: ' + book['average_rating'])
