"""
Double Linked List implemantation with pointers to the first and last
We must keep a pointer to the head and tail of the list.
Every element has a pointer to the next, and previous element.
...
def reverse(list):
    """
    Flips the order of the elements in the list
    """
    pass
